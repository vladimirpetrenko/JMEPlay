...
import com.jmeplay.core.gui.JMEEditorCenter;
...
public class OpenFileHandler extends FileHandler<TreeView<Path>> {
    ...
    @Autowired
    private JMEEditorCenter editorCenter;
    ...
    public ImageView image() {
        return ImageLoader.initImageView(this.getClass(), JMEPLayAssetsResources.ICONS_ASSETS_HANDLER_OPEN, size, size);
    }
