...
public class JMEPlayConsoleArea extends CodeArea {
    ...
    /**
     * JMEPlayConsoleSettings
     *
     * @param settings
     */
    @Autowired
    public void setSettings(JMEPlayConsoleSettings settings) {
        this.jmePlayConsoleSettings = settings;
    }

    /**
     * JMEPlayConsoleLocalization
     *
     * @param localization
     */
    @Autowired
    public void setLocalization(JMEPlayConsoleLocalization localization) {
        this.jmePlayConsoleLocalization = localization;
    }

    /**
     * JMEPlayConsoleToolBar
     *
     * @param toolbar
     */
    @Autowired
    public void setJmePlayConsoleToolBar(JMEPlayConsoleToolBar toolbar) {
        this.jmePlayConsoleToolBar = toolbar;
    }
    ...
    private MenuItem createCopyMenuItem() {
        ImageView copyImage = ImageLoader.initImageView(getClass(),
    ...
    private MenuItem createSelectAllMenuItem() {
        ImageView selectAllImage = ImageLoader.initImageView(getClass(),
    ...
    private MenuItem createClearAllMenuItem() {
        ImageView clearAllImage = ImageLoader.initImageView(getClass(),
